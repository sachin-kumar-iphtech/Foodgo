...
const Product1Screen = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View>
       <Image
              ...
              style={{resizeMode: "contain",margin:"auto",height:320,width:350}}
                     /> 
                     <Text style={{color:"#3C2F2F", fontSize:20,fontWeight:"bold",left:20}}>Fried Chicken Burger</Text>
                     <Text style={{left:20,top:10,color:"#FF9633"}}>★  <Text style={{color:"#808080"}}>4.5  ⎼⎼  14  mins</Text></Text>
                     <Text style={{fontSize:17,paddingHorizontal:20,lineHeight:20,top:20,color:"#6A6A6A",lineHeight:"171.7%"}}>Indulge in our crispy and savory Fried Chicken Burger, made with a juicy chicken patty, hand-breaded and deep-fried to perfection, served on a warm bun with lettuce, tomato, and a creamy sauce.</Text>
      </View>
      ...
      <View style={{flexDirection:"row",top:50}}><TouchableOpacity style={{backgroundColor:"#EF2A39",height:70,width:104,borderRadius:20,alignItems:"center",justifyContent:"center",marginHorizontal:30}}><Text style={{color:"white",fontSize:22,fontWeight:"bold"}}>${count*6.7475}</Text></TouchableOpacity> 
