...
const Product1Screen = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View>
       <Image
              ...
              style={{resizeMode: "contain",margin:"auto",height:320,width:350}}
                     /> 
                     <Text style={{color:"#3C2F2F", fontSize:20,fontWeight:"bold",left:20}}>Hamburger Chicken Burger</Text>
                     <Text style={{left:20,top:10,color:"#FF9633"}}>★  <Text style={{color:"#808080"}}>4.6  ⎼⎼  42  mins</Text></Text>
                     <Text style={{fontSize:17,paddingHorizontal:20,lineHeight:20,top:20,fontWeight:"300",color:"#6A6A6A",lineHeight:"171.7%"}}>Our chicken burger is a delicious and healthier alternative to traditional beef burgers, perfect for those looking for a lighter meal option. Try it today and experience the mouth-watering flavors of our Hamburger Chicken Burger!</Text>
      </View>
      ...
      <View style={{margin:20,paddingTop:8}}>
      ...
      <View style={{flexDirection:"row",top:50}}><TouchableOpacity style={{backgroundColor:"#EF2A39",height:70,width:104,borderRadius:20,alignItems:"center",justifyContent:"center",marginHorizontal:30}}><Text style={{color:"white",fontSize:22,fontWeight:"600"}}>${count*6.24}</Text></TouchableOpacity> 
      <TouchableOpacity onPress={() => navigation.navigate("PaymentScreen")}  style={{backgroundColor:"rgba(60, 47, 47, 1)",height:70,width:200,borderRadius:20,justifyContent:"center",alignItems:"center",marginHorizontal:10}}><Text style={{color:"white",fontSize:18,fontWeight:"600"}}>ORDER NOW</Text></TouchableOpacity></View>
