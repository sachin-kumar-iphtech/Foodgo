...
const Product1Screen = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View>
       <Image
              ...
              style={{resizeMode: "contain",margin:"auto",height:320,width:350}}
                     /> 
                     <Text style={{color:"#3C2F2F", fontSize:22,fontWeight:"600",left:20}}>Hamburger Veggie Burger</Text>
                     <Text style={{left:20,top:10,color:"#FF9633"}}>★  <Text style={{color:"#808080",fontFamily:"roboto"}}>4.8  ⎼⎼  14  mins</Text></Text>
                     <Text style={{fontSize:17,paddingHorizontal:20,lineHeight:20,top:20,fontWeight:"300",color:"#808080",fontFamily:"roboto",lineHeight:"171.7%"}}>Enjoy our delicious Hamburger Veggie Burger, made with a savory blend of fresh vegetables and herbs, topped with crisp lettuce, juicy tomatoes, and tangy pickles, all served on a soft, toasted bun. </Text>
      </View>
      ...
      <View style={{flexDirection:"row",top:50}}><TouchableOpacity style={{backgroundColor:"#EF2A39",height:70,width:104,borderRadius:20,alignItems:"center",justifyContent:"center",marginHorizontal:30}}><Text style={{color:"white",fontSize:22,fontWeight:"bold"}}>${count*9.99}</Text></TouchableOpacity> 
